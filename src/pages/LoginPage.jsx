    ...
    <div className="h-screen w-screen bg-background flex text-foreground">
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden bg-muted/30 border-r border-border items-center justify-center p-12">
        ...
        <div className="max-w-md text-center space-y-6">
          ...
          <h2 className="text-3xl font-heading font-bold text-foreground">Secure your voice analysis</h2>
          <p className="text-muted-foreground text-lg">
            Log in to access your dashboard, review real-time analysis logs, and manage your API keys.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-5">
            ...
            <div className="flex items-center justify-between mt-2">
              <label className="flex items-center space-x-2 text-sm text-muted-foreground cursor-pointer group">
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-4 h-4 text-primary bg-muted border-border rounded focus:ring-primary/50 cursor-pointer"
                />
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-primary text-primary-foreground py-3 px-4 rounded-xl font-medium hover:bg-primary/90 transition-all active:scale-[0.98] disabled:opacity-70 disabled:pointer-events-none mt-2 flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
